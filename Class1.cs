    ...
    internal class Tort
    {
        ...
        public Tort()
        {
            ...
            while (stop != 1)
            {
                ...
                Console.WriteLine($"Полный заказ:\n{zakaz[0]}\n{zakaz[1]}\n{zakaz[2]}\n{zakaz[3]}\n{zakaz[4]}\n{zakaz[5]}\n{zakaz[6]}");
                ...
                switch (key)
                {
                    ...
                    case ConsoleKey.Enter:
                        ...
                        if (pos == 8)
                        {
                            ...
                            {
                                Console.SetCursorPosition(0, 11);
                                Console.WriteLine("Торта без коржа быть не может!");
                                return;
                            }
        ...
        private void Forma()
        {
            ...
            while (stop != 1)
            {
                ...
                Console.WriteLine("  Круглый +10р");
                Console.WriteLine("  Квадратный +10р");
        ...
        private void Vkus()
        {
            ...
            while (stop != 1)
            {
                ...
                Console.WriteLine("  Без начинки +10р");
